...
#include <webots_ros/set_float.h>   //wb_emitter_set_range
#include <webots_ros/get_float.h>   //wb_emitter_get_range
#include <webots_ros/set_string.h>  //wb_emitter_send
#include <webots_ros/set_int.h>     //wb_emitter_set_channel
#include <webots_ros/get_int.h>     //wb_emitter_get_channel // wb_emitter_get_buffer_size
#include <webots_ros/get_bool.h>    //wb_receiver_next_packet
#include <webots_ros/StringStamped.h>   //wb_receiver_get_data
...
{
    ros::init(argc, argv, "chabungas", ros::init_options::AnonymousName);   
    ros::NodeHandle n;
